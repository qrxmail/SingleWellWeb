...
const handleRemove = async (selectedRows) => {
  ...
  try {
    ...
    selectedRows.forEach(async (dto) => {
      await PressurePipeDeviceService.delete(dto);
    })
...
export default () => {
  ...
  const uploadProps = {
    name: 'file',
    action: 'https://localhost:44332/api/app/pressurePipeDevice/uploadFiles',
    headers: {
  ...
  return (
    <PageContainer>
      ...
      <ProTable
        ...
        //   let result = await PressurePipeDeviceService.getAll({
        //     ...params,
        //     sort,
        //     filter,
        //   });
