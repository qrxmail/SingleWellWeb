...
const handleRemove = async (selectedRows) => {
  ...
  try {
    ...
    selectedRows.forEach(async (dto) => {
      await PressureRegulatingStationService.delete(dto);
    })
...
export default () => {
  ...
  const uploadProps = {
    name: 'file',
    action: 'https://localhost:44332/api/app/pressureRegulatingStation/uploadFiles',
    headers: {
  ...
  return (
    <PageContainer>
      ...
      <ProTable
        ...
        //   let result = await PressureRegulatingStationService.getAll({
        //     ...params,
        //     sort,
        //     filter,
        //   });
