...
const handleRemove = async (selectedRows) => {
  ...
  try {
    ...
    selectedRows.forEach(async (dto) => {
      await DeviceTransferService.delete(dto);
    })
...
export default (props) => {
  ...
  const columns = [
    {
      title: "调出单位（原产权单位)",
      dataIndex: "transFromCompany",
    },
    {
      title: "调入单位(或租用单位)",
      dataIndex: "transToCompany",
    },
    {
      title: "调出日期",
    ...
    {
      title: "截止日期",
      dataIndex: "transferExpireDate",
      valueType: "date",
    },
    {
      title: "调动(租赁)依据(命令或合同号)",
      dataIndex: "accordContract",
    },
    {
      title: "调出单位负责人",
      dataIndex: "fromResponsibleStaff",
    },
    {
      title: "调入单位负责人",
      dataIndex: "toResponsibleStaff",
    },
    {
      title: "调出单位移交人",
      dataIndex: "senderStaff",
    },
    {
      title: "调入单位接收人",
  ...
  return (
    <PageContainer>
      ...
      <ProTable
        ...
        //   let result = await DeviceTransferService.getAll({...params,sort,filter});
        //   return result;
        // }}
        rowSelection={{
