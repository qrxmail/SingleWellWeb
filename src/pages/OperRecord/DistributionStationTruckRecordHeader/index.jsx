...
import DistributionStationTruckRecordLine from '../DistributionStationTruckRecordLine/index'
...
export default (props) => {
  ...
  const columns = [
    ...
    {
      title: "供气方式",
      dataIndex: "gasSupplyMode",
    },
    {
      title: "当日累计用气量（Nm³）",
      dataIndex: "acumulativeGasConsumption",
      valueType: "digit",
      hideInSearch: true,
    },
    {
    ...
    {
      title: "加臭机运行时间",
      dataIndex: "odorizerUpTime",
      hideInSearch: true,
    },
    {
      title: "加臭剂量(mg)",
      dataIndex: "odorantDosage",
      hideInSearch: true,
    },
    {
      title: "排污情况",
      dataIndex: "pollutionDischarge",
      hideInSearch: true,
    },
    {
      title: "备注",
    ...
    <PageContainer>
      ...
      {formValues && Object.keys(formValues).length && detailModalVisible ? (
        <Drawer
          ...
          closable={true}
        >
          <DistributionStationTruckRecordLine headerId={row?.id} />
        </Drawer>
      ) : null}
    </PageContainer>
  );
