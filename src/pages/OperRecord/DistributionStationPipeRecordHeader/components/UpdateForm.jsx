...
const UpdateForm = (props) => {
    ...
    const [formVals, setFormVals] = useState({
        ...
        gasSupplyMode: props.values.gasSupplyMode,
        acumulativeGasConsumption: props.values.acumulativeGasConsumption,
        selfUse: props.values.selfUse,
        vent: props.values.vent,
        odorizerUpTime: props.values.odorizerUpTime,
        odorantDosage: props.values.odorantDosage,
        pollutionDischarge: props.values.pollutionDischarge,
        ...
        return (
            <>
                <Row>
                    ...
                    <Col xs={24} sm={24} md={24} lg={24} xl={24}>
                        <FormItem
                            name="acumulativeGasConsumption"
                            label="当日累计用气量（Nm³）"
                        //rules={[{ required: true, message: '请输入管道规格！' }]}
                        >
        ...
        >
            <Form
                ...
                initialValues={{
                    ...
                    gasSupplyMode: formVals.gasSupplyMode,
                    acumulativeGasConsumption: formVals.acumulativeGasConsumption,
                    selfUse: formVals.selfUse,
                    vent: formVals.vent,
                    odorizerUpTime: formVals.odorizerUpTime,
                    odorantDosage: formVals.odorantDosage,
                    pollutionDischarge: formVals.pollutionDischarge,
