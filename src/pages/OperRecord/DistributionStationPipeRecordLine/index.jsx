...
// 新增/修改
const handleUpdate = async (distributionStationPipeRecordId, fields) => {
  ...
  try {
    ...
    fields.distributionStationPipeRecordId = distributionStationPipeRecordId;
    if (fields.isAdd) {
      delete fields.isAdd;
      await add(distributionStationPipeRecordId,fields);
    } else {
      delete fields.isAdd;
      await update(fields);
    }
