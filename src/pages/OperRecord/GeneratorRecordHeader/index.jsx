...
import GeneratorRecordLine from '../GeneratorRecordLine/index'
...
export default (props) => {
  ...
  const columns = [
    ...
    {
      title: "市电停电时间",
      dataIndex: "electricSupplyFailureTime",
      valueType: "digit",
      hideInSearch: true,
    },
    {
      title: "市电来电时间",
      dataIndex: "electricSupplyRecoverTime",
      hideInSearch: true,
    },
    {
      title: "发电机开机时间",
    ...
    <PageContainer>
      ...
      {formValues && Object.keys(formValues).length && detailModalVisible ? (
        <Drawer
          ...
          closable={true}
        >
          <GeneratorRecordLine headerId={row?.id} />
        </Drawer>
      ) : null}
    </PageContainer>
  );
