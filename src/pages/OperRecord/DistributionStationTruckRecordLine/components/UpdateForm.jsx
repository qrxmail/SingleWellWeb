...
const UpdateForm = (props) => {
    ...
    const [formVals, setFormVals] = useState({
        ...
        truckTemperature: props.values.truckTemperature,
        inletPressure: props.values.inletPressure,
        inletTemperature: props.values.inletTemperature,
        heatExchangeTemperatureOne: props.values.heatExchangeTemperatureOne,
        ...
        return (
            <>
                <Row>
                    ...
                    <Col xs={24} sm={24} md={24} lg={24} xl={24}>
                        <FormItem
                            name="heatExchangeTemperatureOne"
                            label="一级换热后温度（℃）"
                        //rules={[{ required: true, message: '请输入管道规格！' }]}
                        >
                            <InputNumber min={1} max={100} style={{ width: '100%' }} />
        ...
        >
            <Form
                ...
                initialValues={{
                    ...
                    truckTemperature: formVals.truckTemperature,
                    inletPressure: formVals.inletPressure,
                    inletTemperature: formVals.inletTemperature,
                    heatExchangeTemperatureOne: formVals.heatExchangeTemperatureOne,
