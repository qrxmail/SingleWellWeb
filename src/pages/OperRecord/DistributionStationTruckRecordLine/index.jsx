...
// 新增/修改
const handleUpdate = async (distributionStationTruckRecordId, fields) => {
  ...
  try {
    ...
    fields.distributionStationTruckRecordId = distributionStationTruckRecordId;
    if (fields.isAdd) {
      delete fields.isAdd;
      await add(distributionStationTruckRecordId, fields);
    } else {
      delete fields.isAdd;
      await update(fields);
    }
...
export default (props) => {
  ...
  const columns = [
    ...
    {
      title: "槽车温度",
      dataIndex: "truckTemperature",
    },
    {
      title: "进站压力（MPa）",
      dataIndex: "inletPressure",
    },
    {
      title: "进站温度（℃）",
    ...
    {
      title: "一级换热后温度（℃）",
      dataIndex: "heatExchangeTemperatureOne",
    },
    {
      title: "一级调压阀后压力（MPa）",
      dataIndex: "regulatPressureOne",
    },
    {
      title: "一级调压阀后温度（℃）",
      dataIndex: "regulatTemperatureOne",
    },
    {
      title: "二级调压阀后压力（MPa）",
      dataIndex: "regulatPressureTwo",
    },
    {
      title: "二级调压阀后温度（℃）",
      dataIndex: "regulatTemperatureTwo",
    },
    {
      title: "过滤器压差（kPa）",
      dataIndex: "filterDifferentPressure",
    },
    {
      title: "瞬时流量（Nm³/h）",
      dataIndex: "flowrate",
    ...
    {
      title: "累计流量（Nm³/h）",
      dataIndex: "acumulativeFlow",
    },
    {
      title: "出站压力（MPa）",
      dataIndex: "outPressure",
    },
    {
      title: "出站温度（℃）",
  ...
  return (
    <PageContainer>
      ...
      <ProTable
        ...
        //   console.log("boilerRecordHeaderId:" + headerId);
