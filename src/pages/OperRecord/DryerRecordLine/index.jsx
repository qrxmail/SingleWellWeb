...
// 新增/修改
const handleUpdate = async (dryerRecordId, fields) => {
  ...
  try {
    ...
    fields.dryerRecordId = dryerRecordId;
    if (fields.isAdd) {
      delete fields.isAdd;
      await add(dryerRecordId, fields);
    } else {
      delete fields.isAdd;
      await update(fields);
    }
  ...
  const columns = [
    ...
    },
    {
      ...
      children: [
        {
          title: "加热器出口",
          dataIndex: "heaterOutlet",
        },
        {
          title: "冷却器出口",
          dataIndex: "coolerOutlet",
        },
        {
          title: "再生器出口",
          dataIndex: "regeneratorOutlet",
        },
        {
          title: "辅加热器表面",
          dataIndex: "auxiliaryHeaterSurface",
        },
        {
          title: "主加热器表面",
          dataIndex: "mainHeaterSurface",
        },
      ]
    },
    {
    ...
    {
      title: "缓冲罐压力（MPa）",
      dataIndex: "pressureOfDewPointBufferTank",
    },
    {
      title: "缓冲罐温度（℃）",
      dataIndex: "bufferTankTemperature",
    },
    {
      title: "排污",
      dataIndex: "blowdown",
