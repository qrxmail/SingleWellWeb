  ...
  const columns = [
    ...
    },
    {
      ...
      children: [
        {
          title: "1#泵",
          dataIndex: "startWaterPumpOne",
          hideInSearch: true,
        },
        {
          title: "2#泵",
          dataIndex: "startWaterPumpTwo",
          valueType: "digit",
          hideInSearch: true,
        },
      ]
    },
    {
      ...
      children: [
        {
          title: "1#泵",
          dataIndex: "operatingPressureOne",
          hideInSearch: true,
        },
        {
          title: "2#泵",
          dataIndex: "operatingPressureTwo",
          hideInSearch: true,
        },
      ]
    },
  ...
  return (
    <PageContainer>
      ...
      <ProTable
        ...
        //   let result = await query({...params,sort,filter});
        //   return result;
        // }}
        rowSelection={{
      ...
      {/* {formValues && Object.keys(formValues).length && detailModalVisible ? (
        <Drawer
          ...
          closable={true}
        >
          <DryerRecordLine headerId={row?.id} />  
        </Drawer>
      ) : null} */}
    </PageContainer>
  );
