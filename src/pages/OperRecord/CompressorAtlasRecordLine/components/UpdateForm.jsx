...
const UpdateForm = (props) => {
    ...
    const [formVals, setFormVals] = useState({
        ...
        exhaustTemperatureThree: props.values.exhaustTemperatureThree,
        oilTemperature: props.values.oilTemperature,
        runState: props.values.runState,
        mainMotorVoltage: props.values.mainMotorVoltage,
        mainMotorCurrent: props.values.mainMotorCurrent,
        highPressureWell: props.values.highPressureWell,
        middlePressureWell: props.values.middlePressureWell,
        lowPressureWellOne: props.values.lowPressureWellOne,
        lowPressureWellTwo: props.values.lowPressureWellTwo,
        upTime: props.values.upTime,
        combustibleGasConcentration: props.values.combustibleGasConcentration,
        ...
        >
            <Form
                ...
                initialValues={{
                    ...
                    exhaustTemperatureThree: formVals.exhaustTemperatureThree,
                    oilTemperature: formVals.oilTemperature,
                    runState: formVals.runState,
                    mainMotorVoltage: formVals.mainMotorVoltage,
                    mainMotorCurrent: formVals.mainMotorCurrent,
                    highPressureWell: formVals.highPressureWell,
                    middlePressureWell: formVals.middlePressureWell,
                    lowPressureWellOne: formVals.lowPressureWellOne,
                    lowPressureWellTwo: formVals.lowPressureWellTwo,
                    upTime: formVals.upTime,
                    combustibleGasConcentration: formVals.combustibleGasConcentration,
