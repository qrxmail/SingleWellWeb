...
// 新增/修改
const handleUpdate = async (boilerRecordId, fields) => {
  ...
  try {
    ...
    fields.boilerRecordId = boilerRecordId;
    if (fields.isAdd) {
      delete fields.isAdd;
      await add(boilerRecordId, fields);
    } else {
      delete fields.isAdd;
      await update(fields);
    }
...
export default (props) => {
  ...
  const columns = [
    ...
    {
      title: "锅炉（1#/2#）",
      dataIndex: "boilerState",
    },
    {
      title: " 循环泵（1#/2#）",
      dataIndex: "circulatingPumpState",
    },
    {
      title: "出水压力（MPa）",
    ...
    {
      title: "出水温度（℃）",
      dataIndex: "outletTemperature",
    },
    {
      title: "回水温度（℃）",
      dataIndex: "backWaterTemperature",
    },
    {
      title: "累计流量（Nm³）",
