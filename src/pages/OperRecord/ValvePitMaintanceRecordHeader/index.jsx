...
const handleUpdate = async (deviceId, fields) => {
  ...
  try {
    ...
    fields.valvePitDeviceId = fields.deviceAndBranch == undefined ? '' : fields.deviceAndBranch[1];
...
export default (props) => {
  ...
  const columns = [
    ...
    {
      title: "CH₄含量（%LEL）",
      dataIndex: "chConcentration",
      hideInSearch: true,
    },
    {
      title: "十字作业",
      dataIndex: "tenWordWork",
      hideInSearch: true,
    },
    {
      title: "是否盘活",
