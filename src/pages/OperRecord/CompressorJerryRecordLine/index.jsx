...
// 新增/修改
const handleUpdate = async (compressorJerryRecordId, fields) => {
  ...
  try {
    ...
    fields.compressorJerryRecordId = compressorJerryRecordId;
    if (fields.isAdd) {
      delete fields.isAdd;
      await add(compressorJerryRecordId, fields);
    } else {
      delete fields.isAdd;
      await update(fields);
    }
  ...
  const columns = [
    ...
    },
    {
      ...
      children: [
        ...
        {
          title: "三级排气",
          dataIndex: "exhaustTemperatureThree",
        },
        {
          title: "油温",
    ...
    },
    {
      ...
      children: [
        {
          title: "中压井",
          dataIndex: "middlePressureWell",
        },
        {
          title: "低压井1",
          dataIndex: "lowPressureWellOne",
        },
        {
          title: "低压井2",
          dataIndex: "lowPressureWellTwo",
        },
      ]
    },
    {
    ...
    {
      title: "可燃气体浓度（%LEL）",
      dataIndex: "combustibleGasConcentration",
    },
    {
      title: "备注",
      dataIndex: "remark",
